...
RSpec.describe Game, type: :model do
  ...
  it { is_expected.to validate_numericality_of(:wildling_threat).is_less_than(13).even }
  # @todo find out how to spec this
  # it { is_expected.to validate_numericality_of(:wildling_threat).is_greater_than_or_equal_to(0) }
